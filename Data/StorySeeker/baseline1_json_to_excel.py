...
parser.add_argument('-i', '--input', type=str, default=r'F:\Work\Debate\PrivousPerspectiveCoder-LM\Data\StorySeeker\gpt-4o_output\baseline1\json\baseline1.json',
                    help='Input JSON file path')
parser.add_argument('-o', '--output', type=str, default=r'F:\Work\Debate\PrivousPerspectiveCoder-LM\Data\StorySeeker\gpt-4o_output\baseline1\excel\baseline1.xlsx',
